...
class ArgumentResolver
{
     ...
     */
    public function getGetParams(string $url, Route $route): array
    {
        $params = [];
    ...
    public function setGetParams(Route $route, array $params)
    {
        $values = [];
        $regexes = [];
        ...
        return preg_replace($regexes, $values, $route->getPath());
    }
}
